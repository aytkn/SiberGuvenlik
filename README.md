...
**nmap --interactive yazarak nmap komut satırına düşebiliriz.
...
https://kali:8834  bağlan

acunetix
Windows için
Web Testlerinde daha başarılı
...
SQL SUS :
	Sql açığı bulunan sitelerde veri tabanı adlarını bulmaya yarar. 2011 yılına kadar geliştirilmiş bir araç.
“sqlsus -g sqlsus.cfg” => config dosyası oluşturduk.
“nano sqlsus.cfg” => içine girdik.
“our url_start” => yazan yere açıklı site adını gir.
“sqlsus sqlsus.cfg”
	Aynı işi yapan başka program:
THEMOLE :
	“url açıklı site adı”
“needle sitedeki bir kelime”
schemas
tables tablo adı
columns tablo adı kolon adı
query kolon adı kullanıcı adı
...
CRUNCH : ***
	...
	“crunch 2 5 123456 -o /root/….”
		“crunch 9 9 ‘1234’ -t Xbank@@@@ -o xbank.txt”
	// 9 harften oluşan, içerisinde 1,2,3,4 rakamları olan, ilk 5 harfi Xbank olacak sonraki 4 harfini 1,2,3,4 rakamlarından kullan
HASHCAT*** :
		Şifre kırmaya yarar.
...
“airodump-ng wlan0mon --manufacturer”
	Üretici listesini güncellemek için =>  “airodump-ng-oui-update”
...
“apt-get install hostapd-wpe”	 =>	Uygulamayı kur.
“leafpad /etc/hostapd-wpe/hostapd-wpe.conf”   	=>	 interface ve ssid ayarlarını değiştir.
“hostapd-wpe -c /etc/hostapd-wpe/hostapd-wpe.conf”	     =>  Sahte yayını başlat.
...
Msi paketinin yüklenmesinin kontrolü : “reg query HKEY_CURRENT_USER\Software\Policies\Microsoft\Windows\Installer”  -> PS ekranına komutu girin. Değer 1 olarak ayarlıysa zafiyet mevcuttur. Zafiyeti tetiklemek için msi paketi üretmek gerekir.
